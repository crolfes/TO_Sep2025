...
write hv_nmos_min_size_guarded_tb_leakage_drain_to_source.raw
.endc
"}
C {vsource.sym} -80 -140 0 0 {name=Vdrain value=0.1 savecurrent=false}
...
C {hv_nmos_w0u3_l10u0_guarded.sym} 20 0 0 0 {name=x1}
