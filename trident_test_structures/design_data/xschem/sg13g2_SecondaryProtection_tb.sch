...
N 650 -620 900 -620 {lab=#net1}
N 820 -460 900 -460 {lab=GND}
N 560 -540 560 -520 {lab=guard}
N 500 -510 520 -510 {lab=vin}
N 860 -510 900 -510 {lab=guard}
N 840 -540 900 -540 {lab=#net2}
...
C {launcher.sym} 700 -750 0 0 {name=h3
...
C {gnd.sym} 650 -560 0 0 {name=l2 lab=GND
value=1.2}
C {vsource.sym} 650 -590 0 0 {name=V1 value=1.2 savecurrent=false}
C {gnd.sym} 820 -460 0 0 {name=l1 lab=GND
value=1.2}
