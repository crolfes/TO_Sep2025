...
N 230 -100 330 -100 {lab=iovdd}
N 230 -70 230 -40 {lab=pad_guard}
N 330 -200 330 -100 {lab=iovdd}
N 60 -200 60 -160 {lab=iovdd}
N -160 -200 60 -200 {lab=iovdd}
N 60 -100 190 -100 {lab=#net1}
N 230 -200 330 -200 {lab=iovdd}
N 230 -200 230 -130 {lab=iovdd}
N 60 -200 230 -200 {lab=iovdd}
N 230 -40 460 -40 {lab=pad_guard}
N -160 -40 230 -40 {lab=pad_guard}
N 460 -110 460 -40 {lab=pad_guard}
N 460 -200 460 -170 {lab=iovdd}
N 330 -200 460 -200 {lab=iovdd}
...
C {iopin.sym} -160 -40 2 0 {name=p8 lab=pad_guard}
C {iopin.sym} -160 -200 2 0 {name=p2 lab=iovdd}
C {iopin.sym} -160 50 2 0 {name=p1 lab=pad
}
