...
N 660 -600 840 -600 {lab=#net1}
N 760 -480 840 -480 {lab=GND}
...
C {gnd.sym} 660 -540 0 0 {name=l2 lab=GND
value=1.2}
C {vsource.sym} 660 -570 0 0 {name=V1 value=1.2 savecurrent=false}
C {gnd.sym} 760 -480 0 0 {name=l1 lab=GND
value=1.2}
...
value=1.2}
C {clamps.sym} 920 -540 0 0 {name=x1}
