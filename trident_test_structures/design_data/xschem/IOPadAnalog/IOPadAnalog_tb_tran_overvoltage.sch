...
value=1.2}
C {lab_pin.sym} -200 -20 0 0 {name=p2 sig_type=std_logic lab=vdd}
...
write IOPadAnalog_tb_tran_overvoltage.raw
.endc
"}
...
"}
C {capa.sym} 200 10 0 0 {name=C1
m=1
value=1p
footprint=1206
device="ceramic capacitor"}
C {gnd.sym} 200 40 0 0 {name=l5 lab=GND
value=1.2}
...
C {vsource.sym} -620 10 0 0 {name=Vin value=1.2 savecurrent=false}
C {sg13g2_IOPadAnalog.sym} 20 20 0 0 {name=x1}
