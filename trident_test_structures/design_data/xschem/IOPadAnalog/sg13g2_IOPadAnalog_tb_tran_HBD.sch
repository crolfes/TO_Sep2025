...
plot v(vout)
*plot ABS(I(Vd)) ylog
*plot ABS(I(v.x1.Vpad_nclamp)+I(v.x1.Vpad_pclamp)) ylog  
*plot ABS(I(v.x1.Vpad_dcndiode)+ I(v.x1.Vpad_dcpdiode))  ylog
*plot ABS(I(v.x1.Vpad_secprot))  ylog
...
C {capa.sym} -490 10 0 0 {name=C2
m=1
value=100p
footprint=1206
device="ceramic capacitor"}
C {gnd.sym} -490 40 0 0 {name=l4 lab=GND
value=1.2}
...
device=resistor
m=1}
C {lab_pin.sym} -490 -20 1 0 {name=p9 sig_type=std_logic lab=vc
value=1.2}
